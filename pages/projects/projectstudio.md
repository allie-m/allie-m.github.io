...
| | |
|:--|:--|
| ![](../assets/projects/projectstudio/flircle.png){ width=260 } | This program triangulates and interactively renders meshes based on a swept surface representation.<br><br>These swept surfaces are defined from bezier curves or B-splines.<br><br>See the "flircle" pictured left.|
...
It is direct illumination only, with one raycast per pixel.
I considered trying to implement global illumination, but realized I would have to rearchitect the program
and so decided against it, as it is not in the course specification.
